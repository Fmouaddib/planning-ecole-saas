  ...
  return (
    <div className="w-full" ref={containerRef}>
      ...
      <div className="relative">
        <button
          type="button"
          className={`w-full bg-white border rounded-lg px-3 py-2 pr-10 text-left
            ...
            {options.map(option => {
              ...
              return (
                <button
                  key={option.value}
                  type="button"
                  className={`w-full text-left px-3 py-2 text-sm flex items-center gap-2 hover:bg-neutral-50 transition-colors ${
