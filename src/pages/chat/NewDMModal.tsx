...
export function NewDMModal({ isOpen, onClose, onSelect }: NewDMModalProps) {
  ...
  useEffect(() => {
    if (isOpen) { fetchUsers(); setSearch('') }
  }, [isOpen, fetchUsers])
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200 dark:border-neutral-700">
          ...
          <button onClick={onClose} className="p-1 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-400">
            <X size={18} />
          </button>
        </div>
        ...
        <div className="px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full pl-8 pr-3 py-2 text-sm rounded-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-400 focus:outline-none focus:ring-1 focus:ring-primary-500"
            />
          </div>
        </div>
