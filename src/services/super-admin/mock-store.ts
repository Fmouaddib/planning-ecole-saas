...
export const MockStore = {
  ...
  addPlan(data: Partial<SubscriptionPlan>): SubscriptionPlan {
    ...
    const p: SubscriptionPlan = {
      ...
      has_subject_links: data.has_subject_links ?? false,
