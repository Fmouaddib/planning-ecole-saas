...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ===================== HERO — CRO MICRO-COPY =====================
  'hero.microcopy': { fr: '✓ Gratuit · ✓ Sans carte bancaire · ✓ Prêt en 2 min', en: '✓ Free · ✓ No credit card · ✓ Ready in 2 min' },

  // ===================== ONBOARDING CRO =====================
  'onboarding.title': { fr: 'Créer mon espace', en: 'Create my workspace' },
  'onboarding.title.success': { fr: 'Félicitations !', en: 'Congratulations!' },
  'onboarding.step1.subtitle': { fr: 'Créez votre espace en quelques secondes', en: 'Create your workspace in seconds' },
  'onboarding.step1.cta': { fr: 'Créer mon espace →', en: 'Create my workspace →' },
  'onboarding.step2.subtitle': { fr: 'Choisissez votre formule', en: 'Choose your plan' },
  'onboarding.field.email': { fr: 'Adresse email', en: 'Email address' },
  'onboarding.field.email.placeholder': { fr: 'jean.dupont@etablissement.fr', en: 'john.doe@institution.com' },
  'onboarding.field.password': { fr: 'Mot de passe', en: 'Password' },
  'onboarding.field.password.placeholder': { fr: 'Minimum 8 caractères', en: 'Minimum 8 characters' },
  'onboarding.field.centerName': { fr: 'Nom de l\'établissement', en: 'Institution name' },
  'onboarding.field.centerName.placeholder': { fr: 'Ex: Institut Avenir Paris', en: 'E.g.: Paris Academy' },
  'onboarding.passwordStrength': { fr: 'Force du mot de passe', en: 'Password strength' },
  'onboarding.passwordStrength.weak': { fr: 'Faible', en: 'Weak' },
  'onboarding.passwordStrength.medium': { fr: 'Moyen', en: 'Medium' },
  'onboarding.passwordStrength.strong': { fr: 'Fort', en: 'Strong' },
  'onboarding.passwordStrength.veryStrong': { fr: 'Très fort', en: 'Very strong' },
  'onboarding.microcopy': { fr: '✓ Gratuit · ✓ Sans carte bancaire · ✓ 2 minutes', en: '✓ Free · ✓ No credit card · ✓ 2 minutes' },
  'onboarding.alreadyAccount': { fr: 'Déjà un compte ?', en: 'Already have an account?' },
  'onboarding.login': { fr: 'Se connecter', en: 'Log in' },
  'onboarding.haveCode': { fr: 'Vous avez un code d\'invitation ?', en: 'Have an invitation code?' },
  'onboarding.joinCenter': { fr: 'Rejoindre un établissement', en: 'Join an institution' },
  'onboarding.backHome': { fr: 'Retour à l\'accueil', en: 'Back to home' },
  'onboarding.success.created': { fr: 'est créé !', en: 'is created!' },
  'onboarding.success.shareCode': { fr: 'Partagez ce code avec vos enseignants et étudiants pour qu\'ils rejoignent votre établissement.', en: 'Share this code with your teachers and students so they can join your institution.' },
  'onboarding.success.enrollmentCode': { fr: 'Code d\'inscription', en: 'Enrollment code' },
  'onboarding.success.goToDashboard': { fr: 'Accéder à mon espace', en: 'Access my workspace' },
  'onboarding.plan.monthly': { fr: 'Mensuel', en: 'Monthly' },
  'onboarding.plan.annual': { fr: 'Annuel', en: 'Annual' },
  'onboarding.plan.free': { fr: 'Gratuit', en: 'Free' },
  'onboarding.plan.startFree': { fr: 'Commencer gratuitement', en: 'Start for free' },
  'onboarding.plan.goToPayment': { fr: 'Continuer vers le paiement', en: 'Continue to payment' },
  'onboarding.plan.changeLater': { fr: 'Vous pourrez changer de plan à tout moment depuis votre profil.', en: 'You can change your plan at any time from your profile.' },
  'onboarding.plan.htMonth': { fr: 'HT/mois', en: 'excl. tax/mo' },
  'onboarding.error.emailRequired': { fr: 'L\'email est requis', en: 'Email is required' },
  'onboarding.error.emailInvalid': { fr: 'Format d\'email invalide', en: 'Invalid email format' },
  'onboarding.error.passwordRequired': { fr: 'Le mot de passe est requis', en: 'Password is required' },
  'onboarding.error.passwordLength': { fr: 'Le mot de passe doit contenir au moins 8 caractères', en: 'Password must be at least 8 characters' },
  'onboarding.error.passwordStrength': { fr: 'Le mot de passe doit contenir une majuscule, une minuscule et un chiffre', en: 'Password must contain an uppercase letter, a lowercase letter and a digit' },
  'onboarding.error.centerRequired': { fr: 'Le nom de l\'établissement est requis', en: 'Institution name is required' },
  'onboarding.error.demoMode': { fr: 'L\'inscription n\'est pas disponible en mode démo.', en: 'Registration is not available in demo mode.' },
  'onboarding.error.emailTaken': { fr: 'Cette adresse email est déjà utilisée. Connectez-vous ou utilisez une autre adresse.', en: 'This email is already in use. Log in or use a different address.' },
  'onboarding.error.rateLimit': { fr: 'Trop de tentatives. Veuillez patienter quelques minutes.', en: 'Too many attempts. Please wait a few minutes.' },
  'onboarding.error.profileTimeout': { fr: 'Timeout lors de la création du profil. Veuillez réessayer.', en: 'Profile creation timed out. Please try again.' },
  'onboarding.error.generic': { fr: 'Erreur lors de la création', en: 'An error occurred during creation' },
  'onboarding.toast.created': { fr: 'Établissement créé avec succès !', en: 'Institution created successfully!' },
  'onboarding.toast.codeCopied': { fr: 'Code copié !', en: 'Code copied!' },
  'onboarding.toast.paymentSuccess': { fr: 'Paiement réussi ! Votre abonnement est actif.', en: 'Payment successful! Your subscription is active.' },
  'onboarding.toast.paymentCancelled': { fr: 'Paiement annulé.', en: 'Payment cancelled.' },
  'onboarding.toast.redirectPayment': { fr: 'Établissement créé ! Redirection vers le paiement...', en: 'Institution created! Redirecting to payment...' },

  // ===================== NAVBAR EXTRA =====================
  'nav.product': { fr: 'Produit', en: 'Product' },

  // ===================== ADMIN — HEADER =====================
  'admin.search.placeholder': { fr: 'Rechercher salles, événements...', en: 'Search rooms, events...' },
  'admin.theme.light': { fr: 'Mode clair', en: 'Light mode' },
  'admin.theme.dark': { fr: 'Mode sombre', en: 'Dark mode' },
  'admin.menu.profile': { fr: 'Mon profil', en: 'My profile' },
  'admin.menu.settings': { fr: 'Paramètres', en: 'Settings' },
  'admin.menu.billing': { fr: 'Facturation', en: 'Billing' },
  'admin.menu.help': { fr: 'Aide & Support', en: 'Help & Support' },
  'admin.menu.logout': { fr: 'Se déconnecter', en: 'Log out' },
  'admin.role.admin': { fr: 'Administrateur', en: 'Administrator' },
  'admin.role.super_admin': { fr: 'Super Admin', en: 'Super Admin' },
  'admin.role.teacher': { fr: 'Enseignant', en: 'Teacher' },
  'admin.role.trainer': { fr: 'Formateur', en: 'Trainer' },
  'admin.role.student': { fr: 'Étudiant', en: 'Student' },
  'admin.role.staff': { fr: 'Personnel', en: 'Staff' },
  'admin.role.coordinator': { fr: 'Coordinateur', en: 'Coordinator' },

  // ===================== ADMIN — SIDEBAR =====================
  'sidebar.dashboard': { fr: 'Tableau de bord', en: 'Dashboard' },
  'sidebar.planning': { fr: 'Planning', en: 'Schedule' },
  'sidebar.mySchedule': { fr: 'Mon emploi du temps', en: 'My schedule' },
  'sidebar.myPlanning': { fr: 'Mon planning', en: 'My planning' },
  'sidebar.academic': { fr: 'Référentiel', en: 'Academic' },
  'sidebar.myClass': { fr: 'Ma classe', en: 'My class' },
  'sidebar.messages': { fr: 'Messages', en: 'Messages' },
  'sidebar.visio': { fr: 'Visio', en: 'Video' },
  'sidebar.sessions': { fr: 'Séances', en: 'Sessions' },
  'sidebar.mySessions': { fr: 'Mes séances', en: 'My sessions' },
  'sidebar.collab': { fr: 'Collaboration', en: 'Collaboration' },
  'sidebar.collabTeachers': { fr: 'Collaboration profs', en: 'Teacher collaboration' },
  'sidebar.rooms': { fr: 'Salles', en: 'Rooms' },
  'sidebar.users': { fr: 'Utilisateurs', en: 'Users' },
  'sidebar.analytics': { fr: 'Statistiques', en: 'Analytics' },
  'sidebar.emails': { fr: 'Emails', en: 'Emails' },
  'sidebar.attendance': { fr: 'Présences', en: 'Attendance' },
  'sidebar.myAttendance': { fr: 'Mes présences', en: 'My attendance' },
  'sidebar.rollCall': { fr: 'Appel', en: 'Roll call' },
  'sidebar.grades': { fr: 'Notes', en: 'Grades' },
  'sidebar.myGrades': { fr: 'Mes notes', en: 'My grades' },
  'sidebar.myTranscript': { fr: 'Mon bulletin', en: 'My transcript' },
  'sidebar.group.enseignement': { fr: 'Enseignement', en: 'Teaching' },
  'sidebar.group.gestion': { fr: 'Gestion', en: 'Management' },
  'sidebar.group.fonctionnalites': { fr: 'Fonctionnalités', en: 'Features' },
  'sidebar.superAdmin': { fr: 'Espace Super Admin', en: 'Super Admin Area' },
  'sidebar.activeSpace': { fr: 'Espace actif', en: 'Active space' },
  'sidebar.role.superAdmin': { fr: 'Super Admin', en: 'Super Admin' },
  'sidebar.role.teacher': { fr: 'Professeur', en: 'Teacher' },
  'sidebar.role.admin': { fr: 'Admin', en: 'Admin' },
  'sidebar.role.student': { fr: 'Étudiant', en: 'Student' },
  'sidebar.viewSite': { fr: 'Voir le site vitrine', en: 'View website' },
  'sidebar.tagline': { fr: 'Gestion premium pour établissements', en: 'Premium management for institutions' },

  // ===================== PRICING PAGE EXTRA =====================
  'pricing.unlimited': { fr: 'Illimité', en: 'Unlimited' },
  'pricing.ttcPrefix': { fr: 'soit', en: 'i.e.' },
  'pricing.ttcSuffix': { fr: 'TTC/mois', en: 'incl. tax/mo' },
  'pricing.redirecting': { fr: 'Redirection...', en: 'Redirecting...' },
  'pricing.subscribe': { fr: 'Souscrire maintenant', en: 'Subscribe now' },

  // ===================== BLOG PAGE =====================
  'blog.linkCopied': { fr: 'Lien copié !', en: 'Link copied!' },
  'blog.notFound.title': { fr: 'Article introuvable', en: 'Article not found' },
  'blog.notFound.desc': { fr: 'Cet article n\'existe pas ou n\'est plus disponible.', en: 'This article does not exist or is no longer available.' },
  'blog.backToBlog': { fr: 'Retour au blog', en: 'Back to blog' },
  'blog.readingTime': { fr: 'min de lecture', en: 'min read' },
  'blog.share': { fr: 'Partager', en: 'Share' },
  'blog.cta.title': { fr: 'Simplifiez la gestion de votre centre de formation', en: 'Simplify your training center management' },
  'blog.cta.desc': { fr: 'Découvrez AntiPlanning, le logiciel de planning intelligent pour centres de formation.', en: 'Discover AntiPlanning, the smart scheduling software for training centers.' },
  'blog.cta.button': { fr: 'Essayer gratuitement', en: 'Try for free' },
  'blog.related': { fr: 'Articles similaires', en: 'Related articles' },
  'blog.category.gestion-centre': { fr: 'Gestion de centre', en: 'Center management' },
  'blog.category.planning-pedagogique': { fr: 'Planning pédagogique', en: 'Educational planning' },
  'blog.category.digitalisation': { fr: 'Digitalisation', en: 'Digitalization' },
  'blog.category.reglementation-formation': { fr: 'Réglementation', en: 'Regulations' },
  'blog.category.conseils-pratiques': { fr: 'Conseils pratiques', en: 'Practical tips' },
  'blog.category.ia-education': { fr: 'IA & Éducation', en: 'AI & Education' },
  'blog.category.temoignages': { fr: 'Témoignages', en: 'Testimonials' },
  'blog.category.productivite': { fr: 'Productivité', en: 'Productivity' },
}
